#include <stdio.h>
// Agregamos la libreria que contiene las funciones que necesitamos para la
// calculadora Se escribe entre comillas ("operaciones.h") porque se encuentra en
// el mismo directorio que el codigo fuente
#include "OperacionesBasicas.h"

// Las funciones no existen en este codigo, se llaman desde la libreria
// operaciones.h
int main() {
